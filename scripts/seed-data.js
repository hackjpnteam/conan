...
// MongoDB接続
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/detective_market_mvp';
...
const sampleBids = [
  {
    ...
    quote: 250000,
    days: 7,
    proposal: "浮気調査の実績が豊富です。GPSを使った追跡と写真・動画による証拠収集を行います。",
  ...
  },
  {
    ...
    quote: 280000,
    days: 10,
    proposal: "30年の実績があります。確実な証拠収集をお約束いたします。",
  ...
  },
  {
    ...
    quote: 200000,
    days: 5,
    proposal: "迅速な対応が自慢です。最新機材を使用した調査を実施します。",
  ...
  },
  {
    ...
    quote: 320000,
    days: 14,
    proposal: "ストーカー対策専門チームがあります。法的手続きのサポートも行います。",
  ...
  },
  {
    ...
    quote: 450000,
    days: 21,
    proposal: "企業調査に特化した専門チームです。詳細な背景調査を実施します。",
...
async function seedDatabase() {
  try {
    ...
    console.log(`${jobs.length}件の案件を挿入しました`);
    ...
    for (const job of jobs) {
      ...
      for (let i = 0; i < numBids; i++) {
        ...
        const bid = {
          ...bidTemplate,
          jobId: job._id,
          quote: bidTemplate.quote + (Math.random() * 100000 - 50000), // ±5万円の変動
    ...
    console.log(`${bidCount}件の入札を挿入しました`);
